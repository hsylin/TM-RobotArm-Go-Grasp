...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AskItem-request>)))
  ...
  (cl:format cl:nil "# Ask: request 'Read'~%# id        : The discription you want to name. ~%# item      : More details please refer to the TM_Robot_Expression.pdf(1.76 rev1.00) Chapter 9.6 TMSVR vs Chapter 9.2 svr_read~%# wait_time : set wait time.~%# More details please refer to the TM_Robot_Expression.pdf(version 1.76_6300) Chapter 9.6 TMSVR~%~%string id~%string item~%~%float64 wait_time~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AskItem-request)))
  "Returns full string definition for message of type 'AskItem-request"
  (cl:format cl:nil "# Ask: request 'Read'~%# id        : The discription you want to name. ~%# item      : More details please refer to the TM_Robot_Expression.pdf(1.76 rev1.00) Chapter 9.6 TMSVR vs Chapter 9.2 svr_read~%# wait_time : set wait time.~%# More details please refer to the TM_Robot_Expression.pdf(version 1.76_6300) Chapter 9.6 TMSVR~%~%string id~%string item~%~%float64 wait_time~%~%~%~%"))
